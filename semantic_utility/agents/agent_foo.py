...
class Agent(object):
	...
	def __init__(
		...
		if self.use_semantic_model:
			...
			self.semantic_model = self.semantic.semantic_model.to(self.device)
...
# --------------------------------------------------------------------------------
				#  Semantic Model Loss
				if self.use_semantic_model:
					semantic_model_loss = self.semantic.semantic_model_loss()
				else:
...
# --------------------------------------------------------------------------------
				...
				#----------------------------------------------------------------------------------
				#Total Loss
				loss = actor_loss+0.5*critic_model_loss
