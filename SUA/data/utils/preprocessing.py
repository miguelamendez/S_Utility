...
class Image():
    def __init__(self,resize=None,interpolation=None,grayscale=False):
        self.resize= resize 
    ...
    def __call__(self,image):
        ...
        return image
#Example
#image=(np.random.standard_normal([8, 8, 3]) * 255).astype(np.uint8)
#print(image)
#plt.imshow(image, interpolation='nearest')
#plt.show()
#img_procc=Image(resize=(4,4),grayscale=True)
#image2= img_procc([image])
#print(image2)
#plt.imshow(image2[0], interpolation='nearest')
#plt.show()
